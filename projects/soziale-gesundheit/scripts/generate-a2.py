...
danach dieses Script ausfuehren (schreibt halbkreise.svg).
...
def build_a2(write_files=True):
    ...
    try:
        ...
        svg = "\n".join(out)
        if write_files:
            _out_path = os.path.join(_DIR, "output", "halbkreise.svg")
            ...
            _tri_path = os.path.join(_DIR, "output", "halbkreise-dreiecke.svg")
            _tri = [
