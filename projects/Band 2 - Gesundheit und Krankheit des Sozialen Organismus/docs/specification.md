# Plandokument — Soziale Gesundheit

**Produkt:** Soziale Gesundheit  
**Untertitel:** Geist, Recht und Wirtschaft — Harmonie und Ungleichgewicht  
**Marke:** Philo von Freisinn  
**Slug:** `soziale-gesundheit`  
**Stand:** Arbeitsspezifikation  
**Stichworte:** Soziale Gesundheit, gesund und krank, zwölf Felder, sozialer Organismus

---

## 1. Produktübersicht

*Soziale Gesundheit* ordnet das Zusammenleben von Geist, Recht und Wirtschaft in **zwölf Felder**. Drei davon zeigen den harmonischen Zustand — nur als Grafik. Neun beschreiben Krankheitssymptome und Beispiele für Ungleichgewicht.

Das Werk erscheint in mehreren Ausdrucksformen aus **einer gemeinsamen Inhaltsquelle** (`soziale-gesundheit.yaml`):
...
> Inhalt der Kombinationsfelder: noch auszuarbeiten (siehe `soziale-gesundheit.yaml`, Status `draft`).
...
Haupttitel *Soziale Gesundheit*: 120–160 pt (A0). Achsenbeschriftung: 48–60 pt.
...
- **Korruption:** Die Politik entscheidet wer gewinnt
...
```
projects/soziale-gesundheit/
├── sss.md                       ← dieses Dokument
├── README.md
├── soziale-gesundheit.yaml      ← Feld-Inventar (Single Source of Truth)
├── halbkreise.py / .svg / .jpg  ← A2
├── halbkreise-a0.py / .svg / .jpg
└── web/                         ← geplant
```
