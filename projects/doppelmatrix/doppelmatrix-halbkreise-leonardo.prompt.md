# Leonardo.ai — Doppelmatrix-Dreiecke (Hilma af Klint)

Init-Bild: `doppelmatrix-halbkreise-dreiecke.png` (nur die beiden Dreiecke, transparent).
...
| Init / Image Guidance | `doppelmatrix-halbkreise-dreiecke.png` |
